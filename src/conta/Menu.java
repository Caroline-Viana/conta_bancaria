...
public class Menu {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("                                                     ");
			System.out.println("      " + Cores.TEXT_GREEN_BOLD + "▌│█║▌║▌║" + Cores.TEXT_RESET
					+ Cores.ANSI_BLACK_BACKGROUND_BRIGHT + " BANCO DO BRAZIL COM Z " + Cores.TEXT_GREEN_BOLD
					+ "║▌║▌║█│▌" + Cores.TEXT_RESET + Cores.ANSI_BLACK_BACKGROUND_BRIGHT + "        ");
